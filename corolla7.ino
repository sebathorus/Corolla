...
void progressive(uint32_t c, uint8_t ledrow) 
     {
      ...
      strip.setPixelColor(ledrow, c);
      strip.setPixelColor(ledrow+6, c);
      strip.setPixelColor(ledrow+12, c);
      strip.setPixelColor(ledrow+18, c);
      strip.setPixelColor(ledrow+24, c);
      strip.setPixelColor(ledrow+30, c);
      strip.show();
  }
