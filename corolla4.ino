...
int red_lcd=110;// value for RED of RGB LED
  ...
  if ((switch1val1 == 0)&&(switch1val2 == 1)&&(switch1val3 == 0))//start switch1 position 3
    {
      ...
      red_lcd = map(pot1RawValue, 0, 1023, 0, 252);
      green_lcd = map(pot2RawValue, 0, 1023, 0, 252);
      blue_lcd = map(pot3RawValue, 0, 1023, 0, 252);
